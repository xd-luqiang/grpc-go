...
func chainUnaryClientInterceptors(cc *ClientConn) {
	...
	if len(interceptors) == 0 {
		...
		chainedInt = func(ctx context.Context, method string, req, reply interface{}, cc *ClientConn, invoker UnaryInvoker, opts ...CallOption) (metadata.MD, error) {
...
func getChainUnaryInvoker(interceptors []UnaryClientInterceptor, curr int, finalInvoker UnaryInvoker) UnaryInvoker {
	...
	return func(ctx context.Context, method string, req, reply interface{}, cc *ClientConn, opts ...CallOption) (metadata.MD, error) {
...
type ClientConnInterface interface {
	...
	// into reply.
	Invoke(ctx context.Context, method string, args interface{}, reply interface{}, opts ...CallOption) (metadata.MD, error)
